...
function buildPaperInfo(paperDetails) {
    if(paperDetails && paperDetails.title && paperDetails.authors) {
        ...
        var journal = "<a target='_blank' href='http://DOI.org/" + paperDetails.doi + "'>" + paperDetails.publication + " (" + year + ") </a>";
        ...
        // cite
        if ((paperDetails.cite != undefined && paperDetails.cite != null && paperDetails.cite != "")) {
        ...
        // download
        if (paperDetails.downloadPath != undefined && paperDetails.downloadPath != null && paperDetails.downloadPath != "") {
            var downloadBtn = "<div class='paper-col-info'><label style='float: left'>Download: &nbsp;</label><p style='float: left'><a href='" + paperDetails.downloadPath + "' title='Download the data source for the chart from this Endpoint' target='_blank'><i class='fa fa-download' style='font-size:20px;'></i></a></p></div>";
            papersection.append(downloadBtn);
        }

        //notebook
        if (paperDetails.notebookPath != undefined && paperDetails.notebookPath != null && paperDetails.notebookPath != "") {
            ...
            if (paperDetails.notebookFile != undefined && paperDetails.notebookFile != null && paperDetails.notebookFile != "") {
    ...
    if(paperDetails.firstName){
        var fullname = paperDetails.middleName ? paperDetails.firstName + " " + paperDetails.middleName + " " + paperDetails.lastName : paperDetails.firstName + " " + paperDetails.lastName;
    ...
    if(workflowDetails && workflowDetails.edges.length > 0) {
        ...
        legendNodes
            .add({
                ...
                y: y + 2 * step,
                label: 'External',
                title: '<b>External:</b><br>The external node represents <br> content that was used <br> within the paper, <br> but not generated within the paper.',
                size: 10,
                shape: 'dot',
                color: 'red',
                fixed: true,
        ...
        legendNodes
            .add({
                ...
                y: y + 3 * step,
                label: 'Dataset',
                title: '<b>Dataset:</b><br>The dataset node represents <br> data generated by <br> either a Tool or Script node.',
                color: 'gray',
                size: 23,
                shape: 'dot',
                fixed: true,
        ...
        legendNodes
            .add({
                ...
                label: 'Script',
                group: 'Script',
                title: '<b>Script:</b><br>The script node represents <br> user-defined procedures <br> utilized in the paper <br> (e.g. to analyze or post-process <br> data belonging to datasets).',
                color: 'green',
                shape: 'triangle',
                size: 23,
                fixed: true,
        ...
        legendNodes
            .add({
                ...
                y: y + 5 * step,
                label: 'Tool',
                title: '<b>Tool:</b><br>The tool node represents <br> an instrument <br>(either software or <br> experimental set up) <br> utilized in the paper.',
                size: 23,
                color: 'blue',
                shape: 'diamond',
                fixed: true,
        ...
        legendNodes
            .add({
                ...
                label: 'Chart',
                group: 'Chart',
                title: '<b>Chart:</b><br>The chart node represents <br> a figure or a table, <br> and is typically considered <br> an end-point within <br> the workflow.',
                color: 'orange',
                shape: 'square',
                size: 23,
                fixed: true,
